  ...
  return (
    <div className="space-y-6">
      ...
      <ul className="grid md:grid-cols-3 gap-4">
        ...
        <li className="border border-neutral-800 rounded-xl p-4">
          <h2 className="font-medium mb-2">Hlaða inn tölfræði</h2>
          <p className="text-sm text-neutral-400">CSV eða Ballchasing API → PlayerGameStat.</p>
          <Link href="/admin/ingest" className="inline-block mt-3 underline">Opna</Link>
        </li>
      </ul>
    </div>
  )
